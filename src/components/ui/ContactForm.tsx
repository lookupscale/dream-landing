...
export function ContactForm() {
  ...
  return (
    <motion.div
      ...
      className="relative bg-light-alt dark:bg-dark-alt border border-zinc-200 dark:border-white/10 rounded-3xl p-8 md:p-12 shadow-premium"
    >
      {status === "success" ? (
        <motion.div
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-zinc-500 uppercase tracking-widest pl-1">
                Name
              </label>
              <input
                required
