...
export const Hero = () => {
  ...
  return (
    <section ref={containerRef} className="relative min-h-[110vh] flex flex-col items-center justify-start pt-40 pb-48 overflow-hidden bg-transparent text-zinc-900 dark:text-white">
      {/* Background Gradient for soft transition */}
      <div className="absolute bottom-0 left-0 right-0 h-64 bg-linear-to-t from-light-alt dark:from-dark-alt to-transparent pointer-events-none z-10" />
